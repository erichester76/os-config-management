...
urlpatterns = [
    ...
    path('config-items/changelog/', views.ConfigItemChangeLogView.as_view(), name='configitem_changelog'),
    ...
    path('config-sets/changelog/', views.ConfigSetChangeLogView.as_view(), name='configset_changelog'),
    ...
    path('os-configs/changelog/', views.OSConfigChangeLogView.as_view(), name='osconfig_changelog'),    
]
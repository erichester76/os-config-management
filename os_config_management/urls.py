...
urlpatterns = [
    ...
    path('config-items/changelog/', views.ConfigItemChangeLogView.as_view(), name='configitem_changelog', kwargs={'model': models.ConfigItem}),
    ...
    path('config-sets/changelog/', views.ConfigSetChangeLogView.as_view(), name='configset_changelog', kwargs={'model': models.ConfigSet}),
    ...
    path('os-configs/changelog/', views.OSConfigChangeLogView.as_view(), name='osconfig_changelog', kwargs={'model': models.OSConfig}),    
]